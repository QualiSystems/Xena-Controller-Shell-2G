...
class Xena_Controller_Shell_2G(object):
    ...
    def password(self):
        ...
        """
        return (
            self.attributes["Xena Controller Shell 2G.Password"]
            if "Xena Controller Shell 2G.Password" in self.attributes
            else None
        )
    ...
    def address(self):
        ...
        """
        return (
            self.attributes["Xena Controller Shell 2G.Address"]
            if "Xena Controller Shell 2G.Address" in self.attributes
            else None
        )
    ...
    def client_install_path(self):
        ...
        """
        return (
            self.attributes["Xena Controller Shell 2G.Client Install Path"]
            if "Xena Controller Shell 2G.Client Install Path" in self.attributes
            else None
        )
    ...
    def controller_tcp_port(self):
        ...
        """
        return (
            self.attributes["Xena Controller Shell 2G.Controller TCP Port"]
            if "Xena Controller Shell 2G.Controller TCP Port" in self.attributes
            else None
        )
    ...
    def test_files_location(self):
        ...
        """
        return (
            self.attributes["Xena Controller Shell 2G.Test Files Location"]
            if "Xena Controller Shell 2G.Test Files Location" in self.attributes
            else None
        )
