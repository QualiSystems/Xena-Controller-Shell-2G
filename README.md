...
### **XenaController 2G Shell**
The **XenaController 2G** shell provides you with connectivity and management capabilities such as device structure discovery and power management for the **XenaController**. 

For more information on the **XenaController**, see the official **Xena** product documentation.

The **XenaController** provides automation commands to run on the chassis, such as Load Configuration, Start/Stop Traffic, Get Statistics. For more information on the Xena Chassis shell, see the following:

* [Xena Chassis 2G Shell](https://community.quali.com/repos/3440/xena-chassis-2-gen-shell)


### Standard version
The **XenaController 2G** shell is based on the Traffic Generator Controller Standard version 2.0.0.

For detailed information about the shell’s structure and attributes, see the [Traffic Shell standard](https://github.com/QualiSystems/shell-traffic-standard/blob/master/spec/traffic_standard.md) in GitHub.

The **Client Install Path** attribute is not relevant for the XenaController.
...
Release: **XenaController 2G**

▪API Server: 8.0.1 GA and above

▪Connection Manager (Windows and Linux): 8.40 EA and above 
...
|Load Configuration|Loads configuration and reserves ports.<br>Set the command input as follows:<br>* **Xena config file name** (config_file_location (String)): Full path to the Xena configuration file name.|
...
The **XenaController 2G** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
...
|:---|:---|
|XenaIxnetworkControllerShell2G.zip|IxNetwork Controller 2G shell package|
|xenacontroller_gen_2_offline_requirements.zip|Shell Python dependencies (for offline deployments only)|

## Importing and Configuring the Shell
This section describes how to import the XenaController 2G shell and configure and modify the shell’s devices. 
...
1. Download the *xenacontroller_gen_2_offline_requirements.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
**To associate the XenaController 2G service to a domain:**
...
**Workflow 1** - *Using thecontroller to runtraffic* 
...
2. In the blueprint toolbar, click **Resource** and drag the Xena Chassis resource into the diagram.
	...
	For example: if you have a configuration with two ports:
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](https://github.com/QualiSystems/Xena-IxNetwork-Controller-Shell-2G/blob/master/ixnetwork_controller_configuration_two_ports.png)
	...
	4. Select the port resources from the pane and drag them into the workspace. The ports are displayed in the **Resource Structure** tab of the chassis resource.
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](https://github.com/QualiSystems/Xena-IxNetwork-Controller-Shell-2G/blob/master/ixnetwork_controller_blueprint_two_ports.png)

3. In the blueprint toolbar, click **App/Service>CS_TrafficGeneratorController** and drag the **XenaController Shell 2G** service into the diagram.

4. Reserve the blueprint.

5. Edit the **XenaController Shell 2G** service parameters if required.

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](https://github.com/QualiSystems/Xena-IxNetwork-Controller-Shell-2G/blob/master/ixnetwork_controller_configuration_parameters.png)
...
6. Map the configuration ports to the blueprint ports. For each port in theconfiguration, assign a physical port from the ports in the blueprint. 
	...
	3. Set the **Logical Name** to the port name in theconfiguration.

	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](https://github.com/QualiSystems/Xena-IxNetwork-Controller-Shell-2G/blob/master/ixnetwork_controller_mapping_ports.png)
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/Xena-IxNetwork-Controller-Shell-2G/releases).
